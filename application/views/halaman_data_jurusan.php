...
<div id="main">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="ketua_jurusan"
                                    placeholder="Masukkan Ketua Jurusan...">
                            </div>
    ...
    <div class="modal fade" id="edit<?= $edit_data->kode_jurusan ?>" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" action="<?= base_url('pengaturan/update_jurusan') ?>"
                        enctype="multipart/form-data">
                        <div class="form-group">
                            <label>Kode Jurusan</label>
                            <input type="text" class="form-control" name="kode_jurusan"
                                placeholder="Masukkan Kode Jurusan..." value="<?= $edit_data->kode_jurusan ?>">
                        </div>

                        <div class="form-group">
                            <label>Nama Jurusan</label>
                            <input type="text" class="form-control" name="nama_jurusan"
                                placeholder="Masukkan Nama Jurusan..." value="<?= $edit_data->nama_jurusan ?>">
                        </div>

                        <div class="form-group">
                            <label>Ketua Jurusan</label>
                            <input type="text" class="form-control" name="ketua_jurusan"
                                placeholder="Masukkan Nama Ketua Jurusan..." value="<?= $edit_data->ketua_jurusan ?>">
                        </div>
                </div>
...
?>
    <div class="modal fade" id="hapus<?= $hapus->kode_jurusan ?>" tabindex="-1" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" action="<?= base_url('pengaturan/delete_data_jurusan') ?>"
                        enctype="multipart/form-data">
                        <p>
