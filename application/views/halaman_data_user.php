...
<div id="main">
    ...
    ?>
        ...
        <div class="modal fade" id="edit<?= $edit_data->id_user ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        <form method="post" action="<?= base_url('pengaturan/update_data_user') ?>" enctype="mutipart/form-data">
                            <div class="form-group">
                                <label>id</label>
                                <input type="text" class="form-control" name="id_user" placeholder="Masukkan Nama..." value="<?= $edit_data->id_user ?>" readonly>
                            </div>

                            <div class="form-group">
                                <label>Nama</label>
                                <input type="text" class="form-control" name="nama" placeholder="Masukkan Username..." value="<?= $edit_data->nama ?>">
                            </div>

                            <div class="form-group">
                                <label>Username</label>
                                <input type="text" class="form-control" name="username" placeholder="Masukkan Password..." value="<?= $edit_data->username ?>">
                            </div>

                            <div class="form-group">
                                <label>Password</label>
                                <input type="text" class="form-control" name="password" placeholder="Masukkan Password..." value="<?= $edit_data->password ?>">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control rounded-0" name="level" required>
                                    ...
                                    <option value="admin" <?= $edit_data->level == 'admin' ? 'selected' : '' ?>> Administrator </option>
                                    <option value="alumni" <?= $edit_data->level == 'alumni' ? 'selected' : '' ?>> Alumni </option>
                                    <option value="guru" <?= $edit_data->level == 'guru' ? 'selected' : '' ?>> Guru/Staff </option>
                                    <option value="perusahaan" <?= $edit_data->level == 'perusahaan' ? 'selected' : '' ?>> Perusahaan </option>
                                </select>
                            </div>
                            <div class="form-group">
                                <label>Status</label>
        ...
        <div class="modal fade" id="hapus_data<?= $hapus_data->id_user ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="post" action="<?= base_url('pengaturan/delete_data_user') ?>" enctyp="multipart/form-data">
                            <p>
